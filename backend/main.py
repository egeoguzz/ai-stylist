...
async def upload_clothing(file: UploadFile = File(...)):
    try:
        ...
        # DB Insert
        data_to_insert = {
            "category": metadata["category"], "color": metadata["color"],
            "season": metadata["season"], "formality": metadata["formality"],
            "description": metadata["description"], "image_url": final_image_url
        }
